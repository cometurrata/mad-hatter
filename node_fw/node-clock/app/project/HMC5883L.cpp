...
Vector_t HMC5883L::readRaw(void)
{
...
{
    *x = readRegister16(HMC5883L_REG_OUT_X_M) - xOffset;
    *y = readRegister16(HMC5883L_REG_OUT_Y_M) - yOffset;
    *z = readRegister16(HMC5883L_REG_OUT_Z_M);
}

Vector_t HMC5883L::readNormalize(void)
{
