...
LSM9DS1::LSM9DS1(uint8_t sda, uint8_t scl, uint8_t xgAddr, uint8_t mAddr)
{
...
uint16_t LSM9DS1::begin()
{
    ...
    Serial.print(mTest); Serial.print(", \t");
    Serial.print(xgTest); Serial.print(", \t");
    Serial.print(_xgAddress); Serial.print(", \t");
    Serial.println(_mAddress);
